...
We are in the process of transitioning this specification from a GitHub README into something a bit more palatable. The official-lookin' version is developed in the `index.bs` file and then deployed to the gh-pages branch; you can see it at http://whatwg.github.io/streams/.
