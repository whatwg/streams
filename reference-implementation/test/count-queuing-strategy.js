...
test('CountQueuingStrategy constructor behaves as expected with wrong arguments', t => {
  ...
  t.doesNotThrow(() => new CountQueuingStrategy({}),
    'construction succeeds with an object without a highWaterMark property');
  t.doesNotThrow(() => new CountQueuingStrategy(highWaterMarkObjectGetter),
    'construction succeeds with an object with a highWaterMark getter');
  t.throws(() => new CountQueuingStrategy(highWaterMarkObjectGetterThrowing), /wow/,
